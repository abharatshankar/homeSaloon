//
//  ServiceProviderServicesModel.swift
//  Home-Salon
//
//  Created by harshitha on 05/10/19.
//  Copyright © 2019 Prashanth. All rights reserved.
//

import Foundation

class ServiceProviderServicesModel{
    ...
    init(providerListData : NSDictionary){
        ...
        if let subCatDict = providerListData["subcategory"] as? [[String:Any]]{
